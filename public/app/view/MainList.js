            ...
            new Ext.XTemplate(
                '<tpl if="this.isFlickr(typeName)">',
                    ...
                    '<div style="min-height:120px;font-family:Arial, sans-serif;">',
                        ...
                        '<div><tpl if="this.isTypeAll()"><span class="typeName">{typeName} : </span></tpl>{title:ellipsis(80, true)}</div>',
                    ...
                    '<tpl if="this.hasImage(image)">',
                        '<div style="min-height:60px;font-family:Arial, sans-serif;">',
                            '<tpl if="this.isTwitter(typeName)">',
                                ...
                                '<div><span class="typeName"><tpl if="this.isTypeAll()">{typeName}</tpl> @{userInfo.screen_name}</span></div>',
                            ...
                            '<tpl else>',
                                ...
                                '<div><tpl if="this.isTypeAll()"><span class="typeName">{typeName} : </span></tpl>{title}</div>',
